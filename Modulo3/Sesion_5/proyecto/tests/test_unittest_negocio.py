...
# Fijar ruta directa a la logica del negocio (negocio.py and __init__.py)
...
class TestVendedor(unittest.TestCase):
    def setUp(self):
        self.vendedor_base = VendedorBase("Luis", 1000)
        self.vendedor_premium = VendedorPremium("Carlos", 2000)
